...
def parse_args():
    ...
    args.add_argument('--base_model', type=str, default='your model')
...
class ScriptArguments:
    ...
    # bs: float = field(default=2, metadata={"help": "Description of the batch_size parameter."})
    ...
    # save_steps: Optional[int] = field(default=600, metadata={"help": "the saving frequency"})
    save_steps: Optional[int] = field(default=1600, metadata={"help": "the saving frequency"})
    eval_steps: Optional[int] = field(default=9000, metadata={"help": "the evaluation frequency"})
...
if __name__ == "__main__":
    ...
    ori_dataset = []
    ori_dataset = Util.load_jsonl(args.dataset)
    ...
    training_args = DPOConfig(
        ...
        max_steps=round(len(train_dataset)/(4*bs))*3*4,
